...
public class CoinServiceImpl implements CoinService{
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        ...
        String url="https://api.coingecko.com/api/v3/coins/markets?vs_currency=cad&per_page=15&page="+page + apikey;
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        String apikey = apiKeyProvider.getKey();
        String url="https://api.coingecko.com/api/v3/coins/"+ coinId + "/market_chart?vs_currency=cad&days="+days+ apikey;
